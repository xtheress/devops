...
- Ответ
    ...
    Обеспечивают шифрование данных между клиентом (например, браузером) и сервером.

    Поддерживают аутентификацию сторон для гарантии подлинности.

    Гарантируют целостность передаваемых данных, предотвращая их подделку или изменение.
